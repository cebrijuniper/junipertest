  ...
  <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
    ...
    <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
      <div class="px-5 py-7">
        ...
        <button type="button" class="transition duration-200 bg-[#76a340] hover:bg-[#5a7b31] focus:bg-[#e1ebcf] focus:shadow-sm focus:ring-4 focus:ring-[#5a7b31] focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-century-semibold text-center inline-block btn-log-in" @click="login()">
...
<button class="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-century-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
